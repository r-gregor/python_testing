...
# data lists -------------------------------------------------------------------
# c - camp, L - list, 1st-num=nsez, 2nd-num=c_vsez
# nsez: nizka sezona (low season), vsez: visoka sezona (high season)
camp_L = [	('odr', 40, 50),
			('otr', 20, 25),
			('parc', 70, 80),
			('avto', 20, 20),
...
# dicts for camp prices nsez and vsez, and for num of days in nsez and vsez:
c_nsez = {}
c_vsez = {}
d_nsez = {}
d_vsez = {}
