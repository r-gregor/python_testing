...
# filename: softlink1_p_fname_to_ulb.py
# version: V1 (20190131)
# version V2 (20190201): confirm action with "run" added""
...
# USAGE
my_usage = '''
        Usage: softlink1_p_fname_to_ulb [filename]
...
my_command = subprocess.call(["sudo", "ln", "-s", "-v", source_path + fname_full, dest_path + fname])
print()
print("[ {} ] -- ".format(tms()) + "Done!")
